package org.caliog.Barkeeper.TopBar.v1_8_R2;
...
import org.caliog.Barkeeper.TopBar.FakeEntity;
...
public class NMSUtil extends org.caliog.Barkeeper.TopBar.NMSUtil {
	...
	private void sendPacket(Player p, Packet<?> packet) {
		net.minecraft.server.v1_8_R2.EntityPlayer player = getHandle(p);
		if (player.playerConnection != null)
			player.playerConnection.sendPacket(packet);
	}

	private net.minecraft.server.v1_8_R2.World getHandle(World world) {
	...
	private net.minecraft.server.v1_8_R2.Entity getHandle(org.bukkit.entity.Entity entity) {
